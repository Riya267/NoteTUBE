...
export default function Dashboard() {
    ...
    return (
        <div className="relative text-slate-500 text-center flex flex-col justify-center items-center w-[80%]">
            {
                isLoading && 
            ...
            {
                !data ? <FormWrapper error={error} invokeNotesApi={invokeNotesApi}/> : 
                <NotesWrapper />
            }
            <ToastContainer 
                position="top-right"
