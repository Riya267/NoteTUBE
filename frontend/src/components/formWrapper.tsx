...
export default function FormWrapper({
  ...
  return (
    <div className="w-full m-10 p-10">
      ...
      <p className="mt-4 text-white">Instantly, without uploading any files!</p>
      <form
        className="flex flex-col lg:flex-row items-center justify-between p-8 mx-6 w-[80%]"
      ...
      >
        ...
        <input
          type="submit"
          className="font-bold rounded-full text-center text-white bg-transparent border-2 border-purple-300 px-6 py-4 m-0 mt-6 lg:mt-0"
          value={'Generate Notes'}
        />
      </form>
      <p className="text-white">Quick and Simple</p>
    </div>
  );
}
